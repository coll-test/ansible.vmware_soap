...
- ansible.vmware_soap.vmware.documentation
'''
...
from ansible_collections.ansible.vmware_soap.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_datacenter_by_name, find_cluster_by_name
from ansible_collections.ansible.vmware_rest.plugins.module_utils.vmware_rest_client import VmwareRestClient
